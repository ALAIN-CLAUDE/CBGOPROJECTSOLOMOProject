({
            ...
            action.setCallback(this,function(response){
                if(response.getState()==='SUCCESS'){
                    ...
                    if(returnValue!=null && returnValue!=''){
                        this.flowsForReview(component, event, helper, returnValue);
                    }
                }
            });
    ...
    loadFlowComponents : function(component, event, helper) {
        ...
        if(reviewId!=null && reviewId!=''){
            this.flowsForReview(component, event, helper, reviewId);
        }
        
	},
    
    flowsForReview : function(component, event, helper, reviewId) {
        var flow = component.find("review");
        var inputVars = [
            {
                name:'reviewId',
                type:'String',
        ...
        flow.startFlow($A.get('$Label.c.Review_Flow_Name_2'),inputVars);
    },
})